...
<tr><td><b>Id</b></td><td><CopyableCode code="gemini.batches.batches" /></td></tr>
</tbody></table>
...
WHERE batchesId = '{{ batchesId }}' -- required
;
```
</TabItem>
<TabItem value="list">
...
```sql
DELETE FROM gemini.batches.batches
WHERE batchesId = '{{ batchesId }}' --required
;
```
</TabItem>
...
```sql
EXEC gemini.batches.batches.cancel 
