...
<tr><td><b>Id</b></td><td><CopyableCode code="gemini.corpora.permissions" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-corporaId"><code>corporaId</code></a>, <a href="#parameter-permissionsId"><code>permissionsId</code></a></td>
    <td></td>
...
granteeType,
role
FROM gemini.corpora.permissions
...
```sql
INSERT INTO gemini.corpora.permissions (
emailAddress,
granteeType,
role,
corporaId
...
```sql
UPDATE gemini.corpora.permissions
SET 
emailAddress = '{{ emailAddress }}',
granteeType = '{{ granteeType }}',
role = '{{ role }}'
WHERE 
corporaId = '{{ corporaId }}' --required
...
```sql
DELETE FROM gemini.corpora.permissions
WHERE corporaId = '{{ corporaId }}' --required
AND permissionsId = '{{ permissionsId }}' --required
;
```
