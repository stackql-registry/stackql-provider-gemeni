...
<tr><td><b>Id</b></td><td><CopyableCode code="gemini.tuned_models.content" /></td></tr>
</tbody></table>
...
<tr>
    <td><a href="#batch_generate_content"><CopyableCode code="batch_generate_content" /></a></td>
    <td><CopyableCode code="exec" /></td>
    <td><a href="#parameter-tunedModelsId"><code>tunedModelsId</code></a></td>
    <td></td>
    <td>Enqueues a batch of `GenerateContent` requests for batch processing.</td>
</tr>
</tbody>
</table>
...
<Tabs
    defaultValue="batch_generate_content"
    values={[
        { label: 'batch_generate_content', value: 'batch_generate_content' }
    ]}
>
<TabItem value="batch_generate_content">

Enqueues a batch of `GenerateContent` requests for batch processing.

```sql
EXEC gemini.tuned_models.content.batch_generate_content 
